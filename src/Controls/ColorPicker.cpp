...
static const int gc_pickChannelHeight = 60;     // As small as boxes will go without clipping.
...
void ColorPicker::CreateColorControl(Gwen::String name, int y)
{
    ...
    colorGroup->SetSize(180, gc_pickChannelHeight);
    ...
    numeric->SetPos(120, 0);
    numeric->SetSize(60, 40);
